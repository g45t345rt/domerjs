...
````json
{
  ...
  getFirstParent: func // get first parent matching predicate

  // Lifecycle events
  onMount: func // called when object is mouted
  onUnMount: func // called when object is unmounted
  onAppend: func // called when object is append to dom
  onDetach: func // called when object is removed from dom
}
````